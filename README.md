...
TLS certificate information utility.

School Purpose Only.

## Overview

Certscope is a polished educational cybersecurity utility by LayerByte. It focuses on one practical defensive concept and keeps the implementation small enough for students to read, run, and understand.

TLS certificate inspection teaches identity, validity, and trust concepts in a practical format.

## Highlights

- Fetches certificate metadata
- Reports validity dates
- Uses Rust error handling for reliable CLI feedback
...
- Hostnames
- TLS certificates presented by authorized endpoints
...
```bash
git clone https://github.com/LayerByte/certscope.git
cd certscope
```
